  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <a
          href="mailto:contact@harperwebservices.com"
          className="feature-card p-6 text-center hover:border-teal-500/50 transition-colors"
        >
          <span className="text-3xl mb-3 block">📧</span>
          <h3 className="font-semibold mb-1">Email</h3>
          <p className="text-sm text-gray-400">contact@harperwebservices.com</p>
        </a>
        <a
