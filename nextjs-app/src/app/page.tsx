  ...
  return (
    <div className="min-h-screen bg-navy px-4 sm:px-8 md:px-12 lg:px-16 py-8 sm:py-12 lg:py-16">
      ...
      <div className="max-w-5xl mb-12 sm:mb-16 lg:mb-24 animate-fadeInUp">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl gradient-text mb-4 sm:mb-6 font-bold">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 sm:mt-8">
          <Link href="/projects" className="btn-primary px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-white font-semibold text-base sm:text-lg inline-block text-center">
            View Projects
          </Link>
          <Link href="/contact" className="bg-navy-light hover:bg-navy-light/80 border border-teal/30 px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-white font-semibold text-base sm:text-lg transition-all inline-block text-center">
            Contact Me
          </Link>
        </div>
      </div>
      ...
      <div className="mb-12 sm:mb-16 lg:mb-24 animate-fadeInUp" style={{ animationDelay: "0.2s" }}>
        <h2 className="text-2xl sm:text-3xl lg:text-4xl text-white mb-6 sm:mb-8 lg:mb-12 font-bold">Core Expertise</h2>
      ...
      <div className="mb-12 sm:mb-16 lg:mb-24 animate-fadeInUp" style={{ animationDelay: "0.4s" }}>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8 lg:mb-12">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl text-white font-bold">Featured Projects</h2>
          <Link href="/projects" className="text-teal hover:text-bright-green font-semibold transition-colors flex items-center gap-2">
            View All
            ...
            {featuredProjects.map((project) => {
              ...
              return projectLink ? (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="modern-card p-4 sm:p-6 rounded-2xl group block cursor-pointer"
                >
                  {cardContent}
                </a>
              ) : (
                <div key={project._id} className="modern-card p-4 sm:p-6 rounded-2xl group">
                  {cardContent}
                </div>
              );
            })}
      ...
      {/* CTA Section */}
      <div className="text-center py-12 sm:py-16 animate-fadeInUp" style={{ animationDelay: "0.6s" }}>
        <h2 className="text-2xl sm:text-3xl text-white mb-4 font-bold">Let&apos;s Work Together</h2>
        <p className="text-white/60 mb-6 max-w-xl mx-auto">
          Have a project in mind? I&apos;d love to hear about it. Let&apos;s discuss how we can work together.
        </p>
        <Link href="/contact" className="btn-primary px-8 py-4 rounded-xl text-white font-semibold text-lg inline-block">
          Get in Touch
        </Link>
      </div>
      ...
      <div className="text-center pb-8">
        <Link href="/admin-login" className="text-white/5 hover:text-white/10 text-xs transition-opacity">
          .
        </Link>
      </div>
    </div>
