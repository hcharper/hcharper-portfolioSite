...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [blogsRes, projectsRes, imagesRes] = await Promise.all([
          fetch("/api/blogs"),
          fetch("/api/projects"),
  ...
  const removeTwitterEmbed = (index: number) => {
    setBlogForm({
      ...blogForm,
  ...
  return (
    <div className="min-h-screen bg-navy px-16 py-16">
      <div className="flex justify-between items-center mb-12">
        <h1 className="text-display gradient-text animate-fadeInUp">Admin Dashboard</h1>
        <button
          onClick={logout}
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  <input
                    ...
                    onKeyPress={(e) => { if (e.key === "Enter") { e.preventDefault(); addTechnology(); } }}
              ...
              <div>
                ...
                {availableImages.length === 0 && (
                  <p className="text-white/40 text-sm mt-1">
                    No images found. Upload images to /public/projects/
                  </p>
                )}
